...
ROOT_URLCONF = 'backend.VidTube.urls'  # path to the urls.py file in root VidTube app folder
...
WSGI_APPLICATION = 'backend.VidTube.wsgi.application'  # path to the wsgi.py file in root VidTube app folder
